...
plt.plot(datos['Generación'], datos['Aptitud Mejor Individuo'], alpha=alpha)
...
plt.figure(figsize=fig_size)
plt.plot(datos['Generación'], datos['Tiempo por generacion'].rolling(window=5).mean(), color='r', alpha=alpha)
...
plt.figure(figsize=fig_size)
plt.plot(datos['Generación'], datos['Tiempo total'], color='g', alpha=alpha)
...
plt.figure(figsize=fig_size)
plt.scatter(datos['Generación'], datos['Uso CPU'], color='y', alpha=alpha)
